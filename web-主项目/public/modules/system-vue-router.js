...
"${base}" should be "${base.replace(/#.*$/, "#")}".`);
      ...
      const START_LOCATION_NORMALIZED = exports("START_LOCATION", {
        path: "/",
        name: void 0,
        params: {},
        query: {},
      ...
      })(NavigationFailureType || exports("NavigationFailureType", NavigationFailureType = {}));
 ...
 ${JSON.stringify(location2)}${currentLocation ? "\nwhile being at\n" + JSON.stringify(currentLocation) : ""}`;
      ...
      const matchedRouteKey = exports("matchedRouteKey", Symbol(process.env.NODE_ENV !== "production" ? "router view location matched" : ""));
      const viewDepthKey = exports("viewDepthKey", Symbol(process.env.NODE_ENV !== "production" ? "router view depth" : ""));
      const routerKey = exports("routerKey", Symbol(process.env.NODE_ENV !== "production" ? "router" : ""));
      const routeLocationKey = exports("routeLocationKey", Symbol(process.env.NODE_ENV !== "production" ? "route location" : ""));
      const routerViewLocationKey = exports("routerViewLocationKey", Symbol(process.env.NODE_ENV !== "production" ? "router view location" : ""));
...
. If you are returning a value instead of calling "next", make sure to remove the "next" parameter from your function.`;
      ...
      const RouterLink = exports("RouterLink", RouterLinkImpl);
      ...
      const RouterView = exports("RouterView", RouterViewImpl);
