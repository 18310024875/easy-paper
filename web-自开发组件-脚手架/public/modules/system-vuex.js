System.register([], function(exports, module) {
  ...
  return {
    execute: function() {
      ...
      var storeKey = exports("storeKey", "store");
      ...
      var Store = exports("Store", function Store2(options) {
        var this$1$1 = this;
        if (options === void 0)
          options = {};
        if (process.env.NODE_ENV !== "production") {
      ...
      var createNamespacedHelpers = exports("createNamespacedHelpers", function(namespace) {
        return {
